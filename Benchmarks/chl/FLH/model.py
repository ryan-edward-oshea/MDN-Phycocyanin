...
params = {
	...
	'MODA'  : [665, 680, 750],
	'MODT'  : [665, 680, 750],
	'HICO'  : [665, 680, 750], #For HICO we now use modis bands in FLH algorithm, (they comapre both in ) Application of the Hyperspectral Imager for the Coastal Ocean to Phytoplankton Ecology Studies in Monterey Bay, CA, USA 
...
@optimize(['a', 'b'],[0,1])
def model(Rrs, wavelengths, sensor, *args, **kwargs): #='HICO'
	...
	# Still need to convert to normalized water leaving radiance
